                    ...
                    {{-- @method('put') --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="category_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                  ...
                                  <!--placeholder-->
                                   <option value="" selected disabled> Edit Category</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="tag_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                  <!--placeholder-->
                                   <option value="" selected disabled> Edit tag</option>
                                    @foreach ($tags as $tag)
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" value="{{ $post->content }}" id="exampleTextarea" name="content" rows="3" ></textarea>
                            </div>
                        </div><br>
